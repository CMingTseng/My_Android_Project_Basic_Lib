 ...
 */
public abstract class PseudoTableSubItem implements AbstractInterface {
	private static final String TAG = PseudoTableSubItem.class.getSimpleName();
	...
	protected ContentObserver mObserver = new ContentObserver(null) {
		...
		public void onChange(boolean selfChange, Uri uri) {
			Log.d(TAG, "BasicTableSubItem onChange");
