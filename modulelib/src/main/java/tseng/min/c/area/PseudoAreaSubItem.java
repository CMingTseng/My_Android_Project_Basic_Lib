 ...
 */
public abstract class PseudoAreaSubItem implements AbstractInterface {
	private static final String TAG = PseudoAreaSubItem.class.getSimpleName();
	...
	protected ContentObserver mObserver = new ContentObserver(null) {
		...
		public void onChange(boolean selfChange, Uri uri) {
			Log.d(TAG, "BasicAreaSubItem onChange");
