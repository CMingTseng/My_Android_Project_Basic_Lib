 ...
 */
public abstract class PseudoPettyCashSubItem implements AbstractInterface {
	private static final String TAG = PseudoPettyCashSubItem.class.getSimpleName();
	...
	protected ContentObserver mObserver = new ContentObserver(null) {
		...
		public void onChange(boolean selfChange, Uri uri) {
			Log.d(TAG, "BasicPettyCashSubItem onChange");
