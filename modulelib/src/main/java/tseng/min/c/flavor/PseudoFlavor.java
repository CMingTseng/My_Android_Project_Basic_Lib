 ...
 */
public abstract class PseudoFlavor implements AbstractInterface {
    private static final String TAG = PseudoFlavor.class.getSimpleName();
    ...
    protected ContentObserver mObserver = new ContentObserver(null) {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            Log.d(TAG, "BasicFlavor onChange");
