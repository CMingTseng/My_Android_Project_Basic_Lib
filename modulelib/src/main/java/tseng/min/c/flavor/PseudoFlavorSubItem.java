 ...
 */
public abstract class PseudoFlavorSubItem implements AbstractInterface {
    private static final String TAG = PseudoFlavorSubItem.class.getSimpleName();
    ...
    protected ContentObserver mObserver = new ContentObserver(null) {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            Log.d(TAG, "BasicFlavorSubItem onChange");
