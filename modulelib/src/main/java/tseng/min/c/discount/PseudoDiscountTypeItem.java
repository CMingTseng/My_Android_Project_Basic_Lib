 ...
 */
public abstract class PseudoDiscountTypeItem implements AbstractInterface {
	private static final String TAG = PseudoDiscountTypeItem.class.getSimpleName();
	...
	protected ContentObserver mObserver = new ContentObserver(null) {
		...
		public void onChange(boolean selfChange, Uri uri) {
			Log.d(TAG, "BasicDiscountTypeItem onChange");
