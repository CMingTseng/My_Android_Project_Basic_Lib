 ...
 */
public abstract class PseudoDiscountSubItem implements AbstractInterface {
	private static final String TAG = PseudoDiscountSubItem.class.getSimpleName();
	...
	protected ContentObserver mObserver = new ContentObserver(null) {
		...
		public void onChange(boolean selfChange, Uri uri) {
			Log.d(TAG, "BasicDiscountSubItem onChange");
